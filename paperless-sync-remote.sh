...
SOURCE_DIR="/Users/fehrimmo/Documents/icloud/FI_Provesta"                              # Lokaler Ordner auf Mac
REMOTE_HOST="158.220.108.87"                                  # Server IP
REMOTE_USER="pp"                                       # SSH Benutzer
REMOTE_DIR="/home/pp/docker/paperless-ngx/data/consume" # Ziel auf Server
